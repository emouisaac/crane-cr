...
const ROLE_CAPABILITIES = {
  manager: [...STANDARD_ADMIN_CAPABILITIES],
  secretary: [
    CAPABILITIES.DASHBOARD_VIEW,
    CAPABILITIES.APPLICATIONS_VIEW,
    CAPABILITIES.BORROWERS_VIEW,
  ...
  loan_officer: [...STANDARD_ADMIN_CAPABILITIES],
  contact_support: [
    CAPABILITIES.DASHBOARD_VIEW,
    CAPABILITIES.BORROWERS_VIEW,
    CAPABILITIES.DOCUMENTS_REQUEST,
...
const SUPER_ADMIN_CAPABILITIES = [...STANDARD_ADMIN_CAPABILITIES, CAPABILITIES.LOANS_APPROVE];
